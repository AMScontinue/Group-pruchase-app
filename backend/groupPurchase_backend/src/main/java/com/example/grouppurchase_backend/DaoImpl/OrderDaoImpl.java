...
public class OrderDaoImpl implements OrderDao {
    ...
    public boolean drawbackOrder(int order_id) {
        ...
        User customer = userRepository.findByUser_id(curOrder.getUser_id());
        Group group = groupRepository.getGroupByGroup_id(curOrder.getGroup_id());
        User header = userRepository.findByUser_id(group.getHead());
